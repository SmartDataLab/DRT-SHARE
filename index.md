...
有比较明显洪水痕迹的区域主要是水源附近植被,农田以及泥沙较多的建筑工地等
```
...
基于无人机、遥感卫星的多源多模态大数据和深度迁移学习技术，实现对灾情现场的快速3D重建，实现灾前灾后对应位置的标注和对比，利用深度卷机网络实现对现场房屋、道路等的实时识别，实现受损标的长度、面积、土方体积等的快速测量和评估。
...
传统深度学习人工智能模型依赖大量标注数据，但实际灾情多样复杂，标注数据稀缺，需要研究建立面向灾前（遥感）灾后（遥感、无人机）图像的自适应迁移学习算法，以真正将无人机遥感影像、地理信息和人工智能技术有效融合。
