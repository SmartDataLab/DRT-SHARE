...
```
我们的整套技术主要是服务与巨灾保险的，我们知道，保险就是风险的资产化，
而保险科技就是用技术手段将原本难以度量的风险快速量化，使之成为可以交易的产品

虽然“防范系统性风险”已经成为了政府工作报告中的一个高频词，但是我国的巨灾保险依然处于探索期，
中国再保险集团、中国地震局、国家减灾中心等机构积极应用遥感技术监控灾害风险，推出地震模型服务于保险产品
总体上监控受灾情况，自动评测受灾等级对实时救援、保险理赔有重要意义

国外洪水保险发展的较早，洪水台风作为一种高频的自然灾害，也客观使得洪水保险模型训练数据相对充足
所以国外是已经涌现了一批与灾害保险相关的所谓的保险科技公司，其中不乏获得上亿美元融资的独角兽企业
应用遥感技术对房屋进行全自动的承保、定损、理赔、续保流程，

但反观国内，虽有房屋险，但不承保川蜀等地震高发区，
虽然可以赔付洪涝损失，但保司会要求个人向气象局申请重大气象灾害证明，
而气象局通常不对个人出示证明，所以很多时候对于灾害理赔的道路是坎坷的，
对于保司来说，管控定损的成本以及保证资产的精算定价都是信息匮乏且压力巨大的。

农业保险是遥感在保险科技中的应用的代表，并且较为成熟,
因为农业具有国家战略上的重要性，其相关技术在遥感界更加成熟，这与巨灾保险是类似的
但是，由于房屋的种类和价值比农作物更加多元、尺寸也比农田更小，
未来很可能需要无人机遥感来提高房屋价值和灾害损失测算的精密程度
...
##### 卫星遥感自动定损
+ 优点：稳定、大尺度的时间序列数据，以持续观测灾害主体，比如山火、洪水。
+ 缺点：角度单一、分辨率低

##### 无人机三维重建
+ 优点：更精细、专注小区域，可以得到斜拍信息，为快速精准评估企业、建筑及工程损坏情况、滑坡塌方土方量等提供了可能。
+ 缺点：人力成本高
---
...
未来可能更加合理的选择是将二者结合，取长补短，这会在后面详细讲解
...
```
由于卫星遥感可以提供连续的时间序列数据，往往可以同时适用灾前、灾后的数据
识别建筑物区域以及不同建筑物的物理受损等级，只用灾后图像通常难度会比较大，
对于灾损严重的区域，只有灾后影像甚至无法识别出正确的建筑物面积。
...
同时灾前灾后的图像通过对比可以更准确的判定单次灾害造成的变化，防范既有损失的房屋骗保，减少逆向选择的问题。
...
| :-: |  :-: |  :-: |
| 采集延时 | 通常15天以上重访  | 灵活 |
| 采集范围 | 通常10^3到10^4km^2 | 飞行限高120m |
| 采集质量 | 分辨率米级 | 4K相机，厘米级 |
| 采集成本  | 限制交易 | 通常设备成本1-5w |
| 历史数据 | 有 | 无 |

---

```
但遥感影像最大的问题在于更新频率不可控，而且有时可能在关键的时间节点出现云遮挡的现象
对于实时救援来说，尤其是救援分秒必争的地震、山火、泥石流等巨型灾害，更快、更自动化的评测是最有必要的，
...
面对巨大的自然灾害，寻找和救援信息闭塞的被困个体形同大海捞针
```
...
8月1日-3日，人大无人机社两名飞手前往河南鹤壁，设备是大疆精灵4Pro和RTK。
...
```
现场无人机数据采用尝试了垂直拍摄和倾斜拍摄，
可以看到都是Z型扫描的路径下倾斜拍摄的路径更长，这是因为需要保证图与图之间有70%的重叠部分，
面对高楼时由于近大远小物体旋转角度不一致，远端物体变化快，难以保证70%的重叠度，
我们采集的建筑工地的图像就因为这个原因合成点云困难，合理的做法是增大飞行高度，
另一种采集比较稳妥的方案是使用五向飞行，如图所示，横向加纵向的飞行使得物体各个面都呈现出来。
```
